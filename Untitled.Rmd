...
Latitude <- c(36.077916, 36.078032, 36.078129, 36.078048, 36.077942, 
              36.089612, 36.077789, 36.077563)
...
xseq <- seq(1,N)
  ...
  IS[1] <- prod(dcauchy(Latitude,thetaq,0.0002))*dcauchy(thetaq,36.07,0.02)/
            dcauchy(thetaq,median(Latitude),10^-4)
for (i in 2:N){
  ...
  IS[i] <- (IS[i-1]*(i-1) + prod(dcauchy(Latitude,thetaq,0.0002))*
              dcauchy(thetaq,36.07,0.02)/dcauchy(thetaq,median(Latitude),10^-4))/i
  #print(i/N*100)
}
...
![img](/Users/Dino/Desktop/Rplot04.jpeg)
